    ...
    ** {@inheritDoc}
    ...
    public Product createProduct(Product product) throws IOException {
        synchronized(products) {
            ...
            Product newProduct = new Product(nextId(),product.getName(), product.getPrice(), product.getQuantity(), product.getDescription(), product.getType(), product.getImage());
    ...
    public Product updateProduct(Product product) throws IOException {
        synchronized(products) {
            ...
            if (product.getName() == null) {
                product.setName(products.get(product.getId()).getName());
            }

            if (product.getQuantity() == 0) {
                product.setQuantity(products.get(product.getId()).getQuantity());
            }

            if (product.getPrice() == 0) {
                product.setPrice(products.get(product.getId()).getPrice());
            }
